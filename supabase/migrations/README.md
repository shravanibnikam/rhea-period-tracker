...
**Applied state: `0001`–`0004` are ALL applied to the production project**
...
> the planned E2EE sequence has shifted forward: owner ciphertext columns → `0005`,
> device_keys/pairing_sessions → `0006`, partner_projections → `0007`, and so on.
...
- **Migrations `0001`–`0004`: applied to production** and exercised — owner sync
