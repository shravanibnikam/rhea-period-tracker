import type { PhaseName, PhaseData } from "@/domain/types";
import { getPhaseRangeLabel, anchorsFrom } from "@/domain/phases";
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
          ...
          >
            Day {cycleDay} of {avgLength} &middot; {getPhaseRangeLabel(phase, anchors)}
          </p>
          {isLate ? (
            <>
              <h1
